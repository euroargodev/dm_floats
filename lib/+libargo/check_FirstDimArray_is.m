...
%   PURPOSE : check that the first dimension of all the array in the
...
% -----------------------------------
%   OUTPUT :
%     Co   (strucure)  -float structure with the DIMNAME dimension in the first place for all
%     the arrays
%     Co.firstdimname    ex: Co.firstdimname='N_PROF';
% -----------------------------------
